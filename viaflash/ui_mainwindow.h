...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(listDevicesButton, 6, 0, 1, 1);
        ...
        gridLayout->addWidget(faceplate, 0, 1, 11, 1);
        ...
        gridLayout->addWidget(dfuResultsTextEdit, 10, 0, 1, 1);

...
min_second5prime = np.array([16, 15])
...
for i in range(0, 128):
    ...
    numerator_int = int(chromatic5prime_ratios[(i + 8) % 12][0])
    denominator_int = int(chromatic5prime_ratios[(i + 8) % 12][1])
    ...
    if octave >= 0:
        ...
        ratio_tag = chromatic5prime_tags[(i - 64) % 12] + "_" + str(abs(octave))

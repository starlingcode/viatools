...
def linearGradient(name):
    ...
    horizontal_gradient.add_stop_color(0, 'white', 1)
    horizontal_gradient.add_stop_color(.25, 'white', 0)
    horizontal_gradient.add_stop_color(.5, 'white', 1)
    horizontal_gradient.add_stop_color(.75, 'white', 0)
    horizontal_gradient.add_stop_color(1, 'white', 1)

    dwg.add(dwg.polyline(
        [(50, 50), (75, 0), (100, 50), (125, 0), (150, 50), (150, 150), (50, 150)],
        stroke='black', fill=horizontal_gradient.get_paint_server(default='currentColor')))

    dwg.save()

if __name__ == '__main__':
    linearGradient("testXBasis.svg")